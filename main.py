...
# print(waveform_train["x_train"])
# print("_----------------------------------------------------------------------------------------------------------------")
# print(waveform_train["x_train"][0])
# print(waveform_train["x_train"][1])
# print("_----------------------------------------------------------------------------------------------------------------")
decision_tree_waveform_gini = DecisionTree("WaveForm", waveform_train)
decision_tree_segmentation_gini = DecisionTree("Segmentation", segmentation_train)
decision_tree_pen_gini = DecisionTree("Pen-based Recognition", pen_train)

# Entropy
decision_tree_waveform_entropy = DecisionTree("WaveForm", waveform_train, "entropy")
decision_tree_segmentation_entropy = DecisionTree("Segmentation", segmentation_train, "entropy")
decision_tree_pen_entropy = DecisionTree("Pen-based Recognition", pen_train, "entropy")

results_decision_tree_waveform_gini = []
results_decision_tree_waveform_gini = []
results_decision_tree_waveform_gini = []
results_decision_tree_waveform_gini = []
results_decision_tree_waveform_gini = []
...
for i in range(folds):
    ...
    # DECISION TREE =============================================================================================================
    # GINI
    # It runs the algorythm and saves the result in a class variable as well
    decision_tree_waveform_gini.run(i)
    decision_tree_segmentation_gini.run(i)
    decision_tree_pen_gini.run(i)

    #Entropy
    decision_tree_waveform_entropy.run(i)
    decision_tree_segmentation_entropy.run(i)
    decision_tree_pen_entropy.run(i)
...
#Gini
decision_tree_waveform_gini.print_results()
decision_tree_segmentation_gini.print_results()
# decision_tree_pen_gini.print_results()
#
# #Entropy
# decision_tree_waveform_entropy.print_results()
# decision_tree_segmentation_entropy.print_results()
# decision_tree_pen_entropy.print_results()
...
# print(f'\nThe result for {acc_pen_kmeans.__str__()} is {round(np.npmean(acc_pen_kmeans) * 100)}%')